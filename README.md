...
SQL-based analysis of global COVID-19 pandemic data to uncover critical insights about infection rates, mortality patterns, and vaccination progress across different countries and continents.
...
Database Platform: Microsoft SQL Server (T-SQL syntax)
Database: COVID19-Data-Exploration
Tables: CovidDeaths,CovidVaccinations, CovidVaccinations
,CovidVaccinations
